...
class TLDNewIMManager{
    void init() {
     JMessage.init(isOpenMessageRoaming: true, appkey:'3003807b24785e5d37bf681d',isProduction: true);
    ...
    void removeRecieveMessageCallBack(String userName)async {
      JMSingle single = JMSingle.fromJson({'username':userName,'appKey':'3003807b24785e5d37bf681d'});
    ...
    Future<dynamic> sendMessage(TLDNewMessageModel messageModel) async{
      ...
      var message;
      JMSingle single = JMSingle.fromJson({'username':messageModel.toUserName,'appKey':'3003807b24785e5d37bf681d'});
    ...
    void getSystemMessageList(int pageFrom,Function(List) success) async{
      JMSingle single = JMSingle.fromJson({'username':'TLDSystem','appKey':'3003807b24785e5d37bf681d'});
