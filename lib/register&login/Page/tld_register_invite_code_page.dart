...
class TLDRegisterInviteCodePage extends StatefulWidget {
  ...
  final TLDRegisterPramater pramater;

  @override
  _TLDRegisterInviteCodePageState createState() =>
      _TLDRegisterInviteCodePageState();
}

class _TLDRegisterInviteCodePageState extends State<TLDRegisterInviteCodePage> {
